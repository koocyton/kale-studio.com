...
export default function PlayStoreButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-white text-gray-900 font-medium text-sm hover:bg-gray-100 transition-all shadow-lg shadow-black/20 hover:shadow-xl hover:scale-[1.02] ${className}`}
    >
      ...
      <span className="flex flex-col items-start leading-tight">
        <span className="text-[10px] uppercase tracking-wide opacity-70">Download</span>
        <span>{label}</span>
      </span>
    </a>
  );
